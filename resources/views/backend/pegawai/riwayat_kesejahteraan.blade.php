...
@section('content')
    ...
    @php
        ...
        $currentRoute = route('backend.kesejahteraan.show', $pegawaiId); 
        ...
        <div class="min-w-full inline-block align-middle">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($riwayat_kesejahteraan as $data)
                            <tr>
                                <td class="border px-6 py-3 text-sm text-gray-800">{{ $riwayat_kesejahteraan->firstItem() + $loop->iteration - 1 }}</td>
           ...
           {{-- MODAL TAMBAH DATA RIWAYAT KESEJAHTERAAN --}}
            ...
            <div class="mt-4 flex justify-end p-4">
                {{ $riwayat_kesejahteraan->links('pagination::tailwind') }}
            </div>
