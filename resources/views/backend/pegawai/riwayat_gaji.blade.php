...
@section('content')
    ...
    @php
        ...
        $currentRoute = route('backend.gaji.show', $pegawaiId); 
    ...
    <div class="overflow-x-auto">
        <div class="min-w-full inline-block align-middle">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($riwayat_gaji as $gaji)
                            <tr>
                                <td class="border border-gray-200 px-6 py-3 text-sm text-gray-800">{{ $riwayat_gaji->firstItem() + $loop->iteration - 1 }}</td>
            ...
            <div class="mt-4 flex justify-end p-4">
                {{ $riwayat_gaji->links('pagination::tailwind') }}
            </div>
