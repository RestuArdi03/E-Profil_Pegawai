...
@section('content')
    ...
    @php
        ...
        $currentRoute = route('backend.asesmen.show', $pegawaiId); 
    ...
    <div class="overflow-x-auto">
        <div class="min-w-full inline-block align-middle">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($riwayat_asesmen as $asesmen)
                            <tr>
                                <td class="border px-6 py-3 text-sm text-gray-800">{{ $riwayat_asesmen->firstItem() + $loop->iteration - 1 }}</td>
            ...
            <div class="mt-4 flex justify-end p-4">
                {{ $riwayat_asesmen->links('pagination::tailwind') }}
            </div>
