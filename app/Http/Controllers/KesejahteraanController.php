...
class KesejahteraanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $riwayat_kesejahteraan = RiwayatKesejahteraan::where('pegawai_id', $pegawaiId) // Filter berdasarkan ID User yang login
        ...
        return view('frontend.kesejahteraan', compact(
            'riwayat_kesejahteraan', 
            'sortBy', 
            'sortDirection'
        ));
    }
