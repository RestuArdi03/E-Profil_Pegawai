...
class KeluargaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data_keluarga = DataKeluarga::where('pegawai_id', $pegawaiId) // Filter berdasarkan ID User yang login
        ...
        return view('frontend.keluarga', compact(
            'data_keluarga', 
            'sortBy', 
            'sortDirection'
        ));
    ...
    public function show(Request $request, string $id)
    {
        ...
        $data_keluarga = DataKeluarga::where('pegawai_id', $id)
                                        ->orderBy($sortBy, $sortDirection)
                                        ->paginate(10)
                                        ->withQueryString();

        // --- 4. Kembalikan View ---
        return view('backend.pegawai.data_keluarga', compact('pegawai', 'data_keluarga', 'sortBy', 'sortDirection'));
    }
